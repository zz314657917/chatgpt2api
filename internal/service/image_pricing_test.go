...
func TestEstimateImageBillingAmount(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "official resolution tier auto quality uses medium estimate",
			model:   util.ImageModelGPTOfficial,
			count:   1,
			size:    "2K",
			quality: "auto",
		...
		{
			name:    "official exact pixel auto quality keeps auto estimate",
			model:   util.ImageModelGPTOfficial,
			count:   1,
			size:    "2048x2048",
			quality: "auto",
		...
		{
			name:    "official resolution tier explicit low quality stays low",
			model:   util.ImageModelGPTOfficial,
			count:   1,
			size:    "2K",
			quality: "low",
		...
		{
			name:    "gemini flash preview image uses reference 2K price",
		...
		{
			name:    "gemini flash official preview image uses official 4K price",
			model:   util.ImageModelGeminiFlashPreviewOfficial,
			count:   1,
			size:    "4K",
			quality: "",
			want:    1269,
		...
		{
			name:    "gemini pro preview image uses reference 4K price",
		...
		{
			name:    "gemini pro official preview image uses official 4K price",
			model:   util.ImageModelGeminiProPreviewOfficial,
			count:   2,
			size:    "4K",
			quality: "",
			want:    4032,
