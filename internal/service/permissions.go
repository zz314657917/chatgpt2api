...
var apiPermissionCatalog = []APIPermission{
	...
	apiPermission("GET", "/api/image-collections", "查看素材集", "素材库", true),
	apiPermission("POST", "/api/image-collections", "创建素材集", "素材库", true),
	apiPermission("PATCH", "/api/image-collections", "编辑素材集", "素材库", true),
	apiPermission("DELETE", "/api/image-collections", "删除素材集", "素材库", true),
	apiPermission("PATCH", "/api/images/visibility", "发布/收回图片", "素材库", false),
	...
	apiPermission("GET", "/api/text-asset-collections", "查看文本素材集", "素材库", true),
	apiPermission("POST", "/api/text-asset-collections", "创建文本素材集", "素材库", true),
	apiPermission("PATCH", "/api/text-asset-collections", "编辑文本素材集", "素材库", true),
	apiPermission("DELETE", "/api/text-asset-collections", "删除文本素材集", "素材库", true),
