...
var apiPermissionCatalog = []APIPermission{
	...
	apiPermission("GET", "/api/images/detail", "查看图片详情", "图片库", false),
	apiPermission("GET", "/api/images/download-url", "获取图片下载链接", "图片库", false),
	apiPermission("POST", "/api/images/uploads", "上传图片", "图片库", false),
	apiPermission("GET", "/api/images/tags", "查看图片标签", "图片库", false),
	apiPermission("PATCH", "/api/images/tags", "编辑图片标签", "图片库", false),
	apiPermission("POST", "/api/images/tags", "编辑图片标签", "图片库", false),
	apiPermission("DELETE", "/api/images/tags", "删除图片标签", "图片库", false),
	apiPermission("PATCH", "/api/images/visibility", "发布/收回图片", "图片库", false),
	apiPermission("PATCH", "/api/images/library-scope", "移动到团队图片库", "图片库", false),
