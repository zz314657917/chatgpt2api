...
export const IMAGE_PROMPT_PRESETS: ImagePromptPreset[] = [
  ...
  {
    id: "ink-wuxia-key-art",
    title: "水墨武侠主视觉",
    prompt:
      "请根据【主题：原创东方武侠群像】生成一张高级电影级水墨武侠主视觉。画面以山门、云海、长桥、古城墙、竹林、飞檐和远山层次构成宏大的江湖空间，主体人物保持端庄完整的传统武侠服饰，姿态沉稳有侠气，重点表现江湖气象、门派秩序、侠义精神和东方审美，不走写真化或擦边化表达。构图应像高品质影视概念海报：前景有风吹衣摆和剑鞘细节，中景有小比例行旅人物与灯火，远景有雾气中的门派建筑和山势轮廓。整体风格融合中国水墨、电影级体积光、宣纸颗粒、克制金色题字和留白版式，色彩以墨黑、雾白、青灰、暗金和少量朱砂为主，氛围庄重、诗意、史诗感强。要求画面安全、端庄、含蓄、有叙事张力，避免艳俗、低俗姿态、廉价游戏截图感和杂乱高饱和。",
    hint: "安全端庄的东方武侠海报、水墨电影感、群像主视觉。",
    imageSrc: "/presets/stellar-poster.webp",
    count: 1,
    size: "9:16",
  },
