...
assert.equal(estimateImageBillingUnits("gemini-3.1-flash-image-preview-official", 1, "2K"), 420);
assert.equal(estimateImageDisplayPriceUSD("gemini-3-pro-image-preview", 2, "4K"), 0.15);
assert.equal(estimateImageBillingUnits("gemini-3-pro-image-preview-official", 2, "4K"), 1050);
