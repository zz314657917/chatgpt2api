...
assert.equal(isHiddenImageModelOption("grok-imagine-1.5"), false);
assert.equal(isHiddenImageModelOption("grok-imagine-1.5-apimart"), true);
assert.equal(isHiddenImageModelOption("grok-imagine-1.5-edit-apimart"), true);
